...
trait InteractsWithContentWorkshop
{
    ...
    protected function getContentWorkshopHeaderActions(): array
    {
        return [
            ...
            ActionGroup::make([
                $this->previewContentAction(),
                $this->viewOnSiteContentAction(),
            ])
                ->label('View')
                ->icon('heroicon-o-eye')
                ->color('gray')
                ->button(),
            ActionGroup::make($this->getContentWorkshopToolActions())
                ->label('Tools')
     ...
     */
    protected function getContentWorkshopToolActions(): array
    {
        $actions = [
            $this->copyAiContextAction(),
            $this->downloadAiContextAction(),
            $this->importContentAction(),
        ];

        if (method_exists($this, 'getContentRevisionToolActions')) {
            $actions = array_merge($actions, $this->getContentRevisionToolActions());
        }

        return $actions;
    }

    protected function previewContentAction(): Action
    {
    ...
    protected function viewOnSiteContentAction(): Action
    {
    ...
    protected function copyAiContextAction(): Action
    {
        return Action::make('copyAiContext')
    ...
    protected function downloadAiContextAction(): Action
    {
        return Action::make('downloadAiContext')
    ...
    protected function importContentAction(): Action
    {
        return Action::make('importContent')
