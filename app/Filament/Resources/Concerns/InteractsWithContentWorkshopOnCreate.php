...
trait InteractsWithContentWorkshopOnCreate
{
    ...
    protected function getContentWorkshopCreateHeaderActions(): array
    {
        return [
            ...
            ActionGroup::make([
                $this->copyAiContextFromCreateAction(),
                $this->downloadAiContextFromCreateAction(),
                $this->importContentFromCreateAction(),
            ])
                ->label('Tools')
    ...
    protected function copyAiContextFromCreateAction(): Action
    {
    ...
    protected function downloadAiContextFromCreateAction(): Action
    {
    ...
    protected function importContentFromCreateAction(): Action
    {
